...
export default function Formulario() {
  ...
  return (
    <div div className='grid place-items-center '>
      ...
      <div class="flex items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-gray-100">
      ...
      <br />
      <div className="flex items-center bg-white rounded-lg border shadow-md md:flex-col md:max-w-xl hover:bg-gray-100">
